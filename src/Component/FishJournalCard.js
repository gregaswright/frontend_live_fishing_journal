    ...
    render() {
        return(
            <div className="JournalCard">
                ...
                {this.props.journal.image && <img className="FishImage" src={this.props.journal.image} alt={this.props.journal.fish_type}></img>}
                {this.props.journal.date && <h5>Date Caught: {this.props.journal.date}</h5>}
                {this.props.journal.fish_length && <h5>Fish Length: {this.props.journal.fish_length}</h5>}
                {this.props.journal.fish_weight && <h5>Fish Weight: {this.props.journal.fish_weight}</h5>}
                {this.props.journal.note && <h5>Notes: {this.props.journal.note}</h5>}
                {this.props.journal.rod_setup && <h5>Rod Setup: {this.props.journal.rod_setup}</h5>}
                {this.props.journal.moon_phase && <h5>Moon Phase: {this.props.journal.moon_phase}</h5>}
                {this.props.journal.tide && <h5>Tide: {this.props.journal.tide}</h5>}
